...
<h2 id="part2">--- Part Two ---</h2><p>The engineers seem concerned; the total calibration result you gave them is nowhere close to being within safety tolerances. Just then, you spot your mistake: some well-hidden elephants are holding a <em>third type of operator</em>.</p>
...
=========
Problem #1
Result: 3245122495150
Time: 18.388509ms
=========
Problem #2
Result: 105517128211543
Time: 341.556839ms
=========
```